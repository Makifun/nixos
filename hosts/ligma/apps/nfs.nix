{ ... }:
{
  ...
  services.nfs.server = {
    ...
    exports = ''
      ...
      /cloud 10.10.10.16(rw,sync,no_subtree_check,no_root_squash,fsid=1) 10.10.10.26(ro,sync,no_subtree_check,no_root_squash,fsid=1) 10.10.10.27(ro,sync,no_subtree_check,no_root_squash,fsid=1) 10.10.10.28(ro,sync,no_subtree_check,no_root_squash,fsid=1)
    '';
  };
}
